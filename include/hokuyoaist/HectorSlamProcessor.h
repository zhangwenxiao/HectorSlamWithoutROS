...
#include <hokuyoaist/OccGridMapUtilConfig.h>
#include <hokuyoaist/ScanMatcher.h>
#include <hokuyoaist/DataPointContainer.h>

#include <hokuyoaist/UtilFunctions.h>

#include <hokuyoaist/MapLockerInterface.h>

#include <hokuyoaist/MapRepresentationInterface.h>
#include <hokuyoaist/MapRepMultiMap.h>
...
public:
  ...
  void getLastPoseMap(Eigen::Vector3f& poseMap)
  {
      Eigen::Vector2f mapCoords (mapTworld * lastMapUpdatePose.head<2>());
      poseMap =  Eigen::Vector3f(mapCoords[0], mapCoords[1], lastMapUpdatePose[2]);
  }
